...
// O projeto continua compilando em modo demonstração antes da inclusão do
// google-services.json. Ao adicionar o arquivo do Firebase, a integração é ativada.
...
dependencies {
    ...
    // Backend compartilhado com o painel web
